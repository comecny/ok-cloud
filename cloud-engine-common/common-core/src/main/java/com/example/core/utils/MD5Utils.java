...
public class MD5Utils {
    ...
    public static String byte2Hex(byte[] inbuf) {
        ...
        for(int i = 0; i < inbuf.length; ++i) {
            String byteStr = byte2HexTable[inbuf[i] & 255];
