...
//                传入一个 Collection<String> 集合
     ...
     * @return true / false
     */
    public boolean save(String key, Object value, long time) {
        try {
            if (time > 0) {
     ...
     * @return 值
     */
    public Object HashRead(String key, String item) {
     ...
     * @return 对应的多个键值
     */
    public Map<Object, Object> HashRead(String key) {
     ...
     * @return true / false
     */
    public boolean hashSave(String key, Map<Object, Object> map) {
        try {
     ...
     * @return true / false
     */
    public boolean hashSave(String key, Map<Object, Object> map, long time) {
        try {
            redisTemplate.opsForHash().putAll(key, map);
            if (time > 0) {
                expire(key, time);
     ...
     * @return true / false
     */
    public boolean hashSave(String key, String item, Object value) {
        try {
     ...
     * @return true / false
     */
    public boolean hashSave(String key, String item, Object value, long time) {
        try {
            redisTemplate.opsForHash().put(key, item, value);
            if (time > 0) {
                expire(key, time);
     ...
     * @return 值
     */
    public Set<Object> setReadAll(String key) {
        try {
     ...
     * @return true / false
     */
    public boolean setKeyRead(String key, Object value) {
        try {
     ...
     * @return 成功个数
     */
    public long setSave(String key, Object... values) {
        try {
     ...
     * @return 成功放入个数
     */
    public long setSave(String key, long time, Object... values) {
        try {
     ...
     * @return
     */
    public List<Object> listSave(String key, long start, long end) {
        try {
     ...
     * @return true / false
     */
    public boolean listSave(String key, Object value) {
        try {
     ...
     * @return true / false
     */
    public boolean listSave(String key, Object value, long time) {
        try {
            redisTemplate.opsForList().rightPush(key, value);
            if (time > 0) {
                expire(key, time);
     ...
     * @return true / false
     */
    public boolean listSave(String key, List<Object> values) {
        try {
     ...
     * @return true / false
     */
    public boolean listSave(String key, List<Object> values, long time) {
        try {
            redisTemplate.opsForList().rightPushAll(key, values);
            if (time > 0) {
                expire(key, time);
